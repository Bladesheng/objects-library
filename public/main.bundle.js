...
/* harmony export */ });
var firebaseConfig = {
    apiKey: "AIzaSyAABZdQ4hsjcFPPvLYCYQb59GnxxeFKS6M",
    authDomain: "objects-library.firebaseapp.com",
    projectId: "objects-library",
    storageBucket: "objects-library.appspot.com",
    messagingSenderId: "449951771317",
    appId: "1:449951771317:web:0fd92240b33363b85cecfc"
};
...
/* harmony export */ });
/* harmony import */ var _Storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Storage */ "./src/modules/Storage.ts");
...
var Library = (function () {
    ...
    function saveToLocalstorage() {
        _Storage__WEBPACK_IMPORTED_MODULE_0__.Storage.books = books;
    }
    return {
        books: books,
        addBook: addBook,
...
/* harmony export */ });
/* harmony import */ var _Library__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Library */ "./src/modules/Library.ts");
/* harmony import */ var _Book__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Book */ "./src/modules/Book.ts");
...
var Storage = (function () {
    ...
    function init() {
        ...
        if (booksJSON !== null) {
            var retrievedBooks = JSON.parse(booksJSON);
            // reconstruct the books instead of using the default value (empty)
            // to keep the methods of books and Library
            for (var _i = 0, retrievedBooks_1 = retrievedBooks; _i < retrievedBooks_1.length; _i++) {
                var book = retrievedBooks_1[_i];
                var reconstructedBook = new _Book__WEBPACK_IMPORTED_MODULE_1__.Book(book.title, book.author, book.pages, book.read);
                _Library__WEBPACK_IMPORTED_MODULE_0__.Library.addBook(reconstructedBook);
            }
            books = _Library__WEBPACK_IMPORTED_MODULE_0__.Library.books;
        }
    }
    return {
        init: init,
...
/* harmony import */ var _modules_Library__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/Library */ "./src/modules/Library.ts");
/* harmony import */ var _modules_Storage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/Storage */ "./src/modules/Storage.ts");
...
var userPicElement = document.querySelector("img.userPic");
var userNameElement = document.querySelector("span.userName");
...
(0,firebase_app__WEBPACK_IMPORTED_MODULE_4__.initializeApp)(firebaseAppConfig);
initFirebaseAuth();
// App
_modules_Storage__WEBPACK_IMPORTED_MODULE_3__.Storage.init();
for (var _i = 0, _a = _modules_Library__WEBPACK_IMPORTED_MODULE_2__.Library.books; _i < _a.length; _i++) {
    var book = _a[_i];
    createBookCard(book);
}
function addBook(newBook) {
    _modules_Library__WEBPACK_IMPORTED_MODULE_2__.Library.addBook(newBook);
    _modules_Library__WEBPACK_IMPORTED_MODULE_2__.Library.saveToLocalstorage();
    createBookCard(newBook);
}
function removeBook(bookIndex) {
    _modules_Library__WEBPACK_IMPORTED_MODULE_2__.Library.removeBook(bookIndex);
    _modules_Library__WEBPACK_IMPORTED_MODULE_2__.Library.saveToLocalstorage();
}
function toggleRead(bookIndex) {
    var clickedBook = _modules_Library__WEBPACK_IMPORTED_MODULE_2__.Library.selectBook(bookIndex);
...
function createBookCard(book) {
    ...
    var randomID = "".concat(title).concat(author).concat(read).concat(Math.floor(Math.random() * 1000000));
    ...
    readCheckbox.addEventListener("click", function () {
        ...
        var allBookElements = gridWrapper.children;
        var bookIndex = Array.from(allBookElements).indexOf(bookCard);
...
form.addEventListener("submit", function (e) {
    e.preventDefault();
    var newBook = new _modules_Book__WEBPACK_IMPORTED_MODULE_1__.Book(titleInput.value, authorInput.value, parseInt(pagesInput.value), readInput.checked);
    addBook(newBook);
